...
class train:
  ...
  file_list_path = '/home/lamberti/work/Dataset/CCPD_crops/train_ccpd_crops'
...
class eval:
  ...
  checkpoint = '/home/lamberti/work/2_steps_license_plates/lp_recognition/pretrained_model/LPRNet_CCPD_no_tile_64_quantized/model.ckpt-250000.ckpt'
  batch_size = 1
